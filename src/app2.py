...
def change_request():
    ...
    return render_template('page.html',prediction_text={'predicted_incident': cr_predicted_incident,'subgroup':cr_subgroup,'similar_incident':similar_incident,'similar_incident_count':similar_incident_count,'server_name_list':server_name_list})
...
def env_change():
    ...
    return render_template('page.html',prediction_text={'predicted_incident': predicted_incident_type,'subgroup':predicted_subgroup})
